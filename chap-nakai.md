...
「これをやればどんなチームでも間違いなくアジャイルになる、という方法はありますか？」[^7]
...
この回答者の方は「スクラムマスター（？）」[^8]だと名乗られ、とても口調がやさしく、穏やかに話される。
...
[^7]:『アジャイルサムライ』の最後の衝撃（アジャイルかどうかの判断を読者にゆだねる）に囚われて、思考が先に進まなくなっていました。
[^8]:『アジャイルサムライ』には「スクラム」という名前だけ載っていますが、SM（Scrum Master）等の詳細な説明はありません。
